...
class Dataset(data.Dataset):
    def __init__(self, root, dataset_name='diffractionheat', 
            num_points=2048, split='train', load_name=False,
            random_rotate=False, random_jitter=False, random_translate=False):

        assert dataset_name.lower() in ['diffractionraw', 'heat','diffractiontest', 'shapenetcorev2', 
            'shapenetpart', 'modelnet10', 'modelnet40', 'diffraction', 'tttt']
