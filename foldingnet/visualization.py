...
def visualize(args):
    ...
    dataset = Dataset(root=args.dataset_root, dataset_name=args.dataset, 
                        num_points=args.num_points, split=args.split, load_name=False)

    # load data from dataset
    # pts, lb, n = dataset[args.item]
    pts,lb = dataset[args.item]
    n = ''
    ...
    if args.draw_original:
        ...
        savemat("/content/drive/MyDrive/202105_nanoDiffraction/results/raw_pcl.mat",mdic)
    ...
    if one_model:
        ...
        for path in load_path:
            ...
            savemat(os.path.join("/content/drive/MyDrive/202105_nanoDiffraction/results/rec_" + model_name[:-4] +".mat"),mdic)
...
if __name__ == '__main__':  
    ...
    parser.add_argument('--dataset', type=str, default='shapenetcorev2', metavar='N',
                        choices=['shapenetcorev2','modelnet40', 'modelnet10','diffraction'],
